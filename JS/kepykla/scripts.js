...
document.getElementById('reset').addEventListener('click', function() {
  ...
  /* INSTRUKCIJOS:
    ...
    - Šiame projekte atliktas tik pradinis stiliavimas, tačiau galima padaryti ir daugiau dalykų. 
    Pagalvokite ar galima kaip nors atnaujinti dizainą, jo nesudarkant.
    Pavyzdžiui, gal gali įvesties laukeliai reaguoti į pelės užvedimą, ar patvarkyti gal kokius tarpus, gal įnešti kokių spalvų įvairiose vietose, dar gal ką nors padaryti su įvesties laukeliais, mygtukų stiliai, ir pan.
...
function toggleColor() {
   ...
   let currentColor = bottomElement.style.backgroundColor;
   bottomElement.style.backgroundColor = (currentColor === 'lightblue') ? 'white' : 'lightblue';
}
...
function toggleVisibility() {
    var toggle = document.querySelector('.darbo-laiko-toggle input[type="checkbox"]');
    var darboDienos = document.querySelector('.darboo_dienom');
    var savaitgalis = document.querySelector('.savaitgalis');
    
    if (toggle.checked) {
        darboDienos.style.display = 'none';
        savaitgalis.style.display = 'block';
    } else {
        darboDienos.style.display = 'block';
        savaitgalis.style.display = 'none';
    } 
}
